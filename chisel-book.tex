...
In the previous chapter's exercise, you have extended the blinking LED example with some input
...
\code{delayIn} to the input of the register.

Note also that the name of the register
...
\code{enable} is low (\code{false}), and the register keeps its value (5) at rising edge D.
